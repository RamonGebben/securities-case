...
/***/ function(module, exports, __webpack_require__) {
	...
	var _animatable = __webpack_require__(2);
	...
	var _animation_group = __webpack_require__(10);
	...
	var _animation_sequence = __webpack_require__(11);
	...
	var Effect = function (_Component) {
	    ...
	    _createClass(Effect, [{
	        ...
	        value: function startAnimation() {
	            var player = document.timeline.play(this.effect);
	        ...
	        key: 'updatePlayState',
	        value: function updatePlayState(props) {
	            if (this.state.player) {
	                var currentState = this.state.player.playState;
	        ...
	        key: 'updateTime',
	        value: function updateTime(props) {
	            if (this.state.player) {
	                this.state.player.pause();
	...
	var Animation = function (_Animatable) {
	    ...
	    _createClass(Animation, [{
	        ...
	        value: function startAnimation() {
	            ...
	            var player = this.node.animate(this.keyframes, this.timing.toJS());
	            this.setState({ player: player });
	        }
	    }, {
	        key: 'componentWillReceiveProps',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _effect = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(8)(module), (function() { return this; }()) || Function('return this')()))
